...
from data_model.config.config_entry import ConfigEntry, DefinitionKey, DefinitionType
...
class Config:
    ...
    def __init__(self, definition_path: str, saved_value_path: Optional[str], child_class) -> None:
        ...
        child_class: class
            Class where definition keys should be written as properties when first initialized.
        """

...
class DualToggle(QWidget):
    ...
    def __init__(self, parent, options, config=None, orientation=Qt.Orientation.Horizontal):
        """__init__.
        ...
        options : list of str
            Option names. Currently must be length 2, other lengths will raise ValueError.
        option2 : str
            Second option name.
    ...
    def set_tooltips(self, text1, text2):

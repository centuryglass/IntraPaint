...
TR_ID = 'ui.panel.tool_control_panels.shape_selection_panel'
...
class ShapeSelectionPanel(SelectionPanel):
    ...
    def __init__(self, selection_layer: SelectionLayer) -> None:
        ...
        self._mode_toggle = DualToggle(self, [MODE_RECT, MODE_ELLIPSE], Qt.Orientation.Horizontal)
        # TODO: shape icons
        self._mode_toggle.setValue(MODE_RECT)

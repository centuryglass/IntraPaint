...
class PixmapLayerCanvas(LayerCanvas):
    ...
    @staticmethod
    def _draw_event_path(painter: QPainter, input_event: 'PixmapLayerCanvas._InputEvent') -> None:
        painter.save()
    ...
    def _draw_input_event(self, input_event: 'PixmapLayerCanvas._InputEvent', layer_painter: QPainter,
